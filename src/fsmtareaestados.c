...
typedef enum{
	ESTADO_INICIAL,     //Inicializaciones
	ESTADO_MENU_ENSAYOS,//Menu ensayos
...
//Estados posibles en el caso del ensayo de longitud de onda determinada
typedef enum{
	ENSAYO_ELOD_INICIAL,
...
void ensayos(void);
void ensayosElod(void);
void ensayoEblo(void);
...
void ensayosElod(void){
	...
	case ENSAYO_ELOD_MUESTRAVALOR:
		...
		//Muestro valor de longitud de onda posicionado,valor analogico leido (absorbancia) y
		//Transmitancia calculada en tarea
